...
from yourapp.grammarmetrics import grammarmetrics
...
class givememyscore:
    ...
    def scale_smog(self, score):
        scaled = (((score - 5)/(18-5)) * 100)
        return scaled

    def scale_grammar(self, score):
        scaled = 100 - (score * 100)
        return scaled
    ...
    def startevaluation(self, text):
        ...
        metrics = dict()
        metrics['wordfrequency_all'] = self.scale_freq(self.lex.wordfrequency_all)
        ...
        metrics['wordrangescore'] = self.scale_wordrange(self.lex.wordrangescore)
        ...
        metrics['familiarityscore'] = self.scale_familiarity(self.lex.familiarityscore)
        ...
        metrics['grammar_errorrate'] = self.scale_grammar(self.grammar.errorrate)
        ...
        metrics['smog'] = self.scale_smog(self.readability.smog)
