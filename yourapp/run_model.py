...
def main(student_essay):
    ...
    #tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
    tokenizer = BertTokenizer.from_pretrained('/home/flask/app/yourapp/Set1to7Sigmoid')

    MAX_LEN = 384


    model = BertForSequenceRegression.from_pretrained('/home/flask/app/yourapp/Set1to7Sigmoid',
                                                      num_labels=1)
    model.cuda()
