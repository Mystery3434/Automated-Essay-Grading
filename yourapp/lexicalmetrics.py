...
class lexicalmetrics:
    ...
    def generatescore(self,tokenized_text):
            try:
                f = open("/home/flask/app/yourapp/written.num","r", encoding="utf8")
                f1 = open("/home/flask/app/yourapp/awl.txt","r", encoding="utf8")
                f2 = open("/home/flask/app/yourapp/sublist1.txt","r", encoding="utf8")
                f3 = open("/home/flask/app/yourapp/sublist2.txt","r", encoding="utf8")
                f4 = open("/home/flask/app/yourapp/sublist3.txt","r", encoding="utf8")
                f5 = open("/home/flask/app/yourapp/sublist4.txt","r", encoding="utf8")
                f6 = open("/home/flask/app/yourapp/sublist5.txt","r", encoding="utf8")
                f7 = open("/home/flask/app/yourapp/sublist6.txt","r", encoding="utf8")
                f8 = open("/home/flask/app/yourapp/sublist7.txt","r", encoding="utf8")
                f9 = open("/home/flask/app/yourapp/sublist8.txt","r", encoding="utf8")
                f10 = open("/home/flask/app/yourapp/sublist9.txt","r", encoding="utf8")
                f11 = open("/home/flask/app/yourapp/sublist10.txt","r", encoding="utf8")
                f12 = open("/home/flask/app/yourapp/familiarity.txt","r", encoding="utf8")
                f13 = open("/home/flask/app/yourapp/concreteness.txt","r", encoding="utf8")
                f14 = open("/home/flask/app/yourapp/imagability.txt","r", encoding="utf8")
                f15 = open("/home/flask/app/yourapp/meaningfulness_coloradonorms.txt","r", encoding="utf8")
                f16 = open("/home/flask/app/yourapp/meaningfulness_paivionorms.txt","r", encoding="utf8")
                f17 = open("/home/flask/app/yourapp/ageofacquisition.txt","r", encoding="utf8")
            except IOError:
