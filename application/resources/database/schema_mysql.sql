...
CREATE TABLE `tbl_submit_document_stat` (
  ...
  `wordfrequency_all` TEXT,
  `wordfrequency_content` TEXT,
  `wordfrequency_function` TEXT,
  `wordrangescore` TEXT,
  `academicwordscore` TEXT,
  `academic_sublists_score` TEXT,
  `familiarityscore` TEXT,
  `concretenessscore` TEXT,
  `imagabilityscore` TEXT,
  `meaningfulnesscscore` TEXT,
  `meaningfulnesspscore` TEXT,
  `ageofacquisitionscore` TEXT,
  `grammar_errorrate` TEXT,
  `flesch_reading_ease` TEXT,
  `flesch_kincaid_grade_level` TEXT,
  `smog` TEXT,
  `coleman_liau` TEXT,
  `ari` TEXT,
  `semanticoverlap` TEXT,
  `typetokenratio` TEXT,
  `holistic_score` TEXT,
  `fact_status` TEXT,
  `fact_count` TEXT,
